const portfolio = {
  ...
  metrics: [
    { label: "Order Turnaround Time (TAT)", value: "Reduced 50%-60%" },
    { label: "Machine Monitoring Time", value: "Reduced 30%" },
    { label: "Factory Downtime", value: "Reduced 40%" },
  ...
  projects: [
    {
      name: "OrderX",
      description: "A B2B ordering platform with sales execution and customer onboarding.",
      problem: "Businesses take orders on paper and then manually enter them into their systems to process.",
      solution: "Customers can directly order from a web or mobile app, allowing dispatch executives to simply map orders to dispatch centers which then automatically post to the ERP system for invoicing.",
      impact: "Reduced order Turnaround Time (TAT) by 50% - 60%.",
      stack: ["Node.js", "Express.js", "ERP Integration"],
      link: "https://orderx.cloud",
    },
    {
      name: "manufex.cloud",
      description: "A high-performance real-time data streaming pipeline and live machine monitoring dashboard.",
      problem: "End-users lacked real-time visibility into machine health and experienced extensive diagnostic lag.",
      solution: "Architected an event-driven flow on GCP utilizing Pub/Sub for ingestion, Dataflow for streaming data processing, and BigQuery for analytical data warehousing.",
      impact: "Reduced machine monitoring time by 30% and minimized overall factory downtime by 40%.",
      stack: ["GCP", "Pub/Sub", "Dataflow", "BigQuery"],
      link: "https://manufex.cloud",
    },
    {
      name: "CCA-F Exam Preparation",
      description: "An interactive exam preparation mobile application targeting cloud certification syllabi.",
      problem: "Candidates lacked an application to simulate extensive technical questionnaire banks with active performance tracking.",
      solution: "Developed and published a mobile application with a large, high-throughput question bank structured for smooth progression tracking.",
      impact: "Successfully deployed to production and actively available on the Google Play Store.",
      stack: ["Flutter", "Dart", "Database Optimization"],
